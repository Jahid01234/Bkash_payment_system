...
class CreatePaymentResponseModel {
  ...
  CreatePaymentResponseModel copyWith({
    String? paymentID,
  ...
  factory CreatePaymentResponseModel.fromMap(Map<String, dynamic> map) {
    return CreatePaymentResponseModel(
  ...
  factory CreatePaymentResponseModel.fromJson(String source) =>
      CreatePaymentResponseModel.fromMap(
          json.decode(source) as Map<String, dynamic>);

  @override
  String toString() {
    return 'CreatePaymentSuccess(paymentID: $paymentID, paymentCreateTime: $paymentCreateTime,'
        ' transactionStatus: $transactionStatus, amount: $amount, currency: $currency, '
        'intent: $intent, merchantInvoiceNumber: $merchantInvoiceNumber, bkashURL: $bkashURL,'
        ' callbackURL: $callbackURL, successCallbackURL: $successCallbackURL, '
        'failureCallbackURL: $failureCallbackURL, cancelledCallbackURL: $cancelledCallbackURL,'
        ' statusCode: $statusCode, statusMessage: $statusMessage)';
  }

  @override
  bool operator ==(covariant CreatePaymentResponseModel other) {
