...
class ExecutePaymentResponseModel {
  ...
  factory ExecutePaymentResponseModel.fromJson(String source) =>
      ExecutePaymentResponseModel.fromMap(json.decode(source) as Map<String, dynamic>);

  @override
  String toString() {
    return 'ExecutePaymentResponse(paymentID: $paymentID, customerMsisdn: $customerMsisdn,'
        ' payerReference: $payerReference, paymentExecuteTime: $paymentExecuteTime, '
        'trxID: $trxID, transactionStatus: $transactionStatus, amount: $amount, '
        'currency: $currency, intent: $intent, merchantInvoiceNumber: $merchantInvoiceNumber,'
        ' statusCode: $statusCode, statusMessage: $statusMessage)';
  }

  @override
  bool operator ==(covariant ExecutePaymentResponseModel other) {
